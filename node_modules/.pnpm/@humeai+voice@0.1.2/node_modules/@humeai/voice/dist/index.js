...
var JSONErrorMessageSchema = import_zod6.z.object({
...
var TimeSliceSchema = import_zod7.z.object({
  begin: import_zod7.z.number(),
  end: import_zod7.z.number()
});

// src/models/user-interruption-message.ts
var UserInterruptionMessageSchema = import_zod8.default.object({
  type: import_zod8.default.literal("user_interruption"),
  time: import_zod8.default.union([TimeSliceSchema, import_zod8.default.number(), import_zod8.default.null()]).catch(null)
}).transform((obj) => {
  return Object.assign(obj, {
    receivedAt: /* @__PURE__ */ new Date()
  });
...
var UserTranscriptMessageSchema = import_zod9.default.object({
  type: import_zod9.default.literal("user_message"),
  message: import_zod9.default.object({
    role: import_zod9.default.literal("user"),
...
// src/models/json-message.ts
var JSONMessageSchema = import_zod10.default.union([
...
var AuthStrategySchema = import_zod11.default.union([
  import_zod11.default.object({
    type: import_zod11.default.literal("apiKey"),
    value: import_zod11.default.string({
      description: "API key for the Hume API is required"
    })
  }),
  import_zod11.default.object({
    type: import_zod11.default.literal("accessToken"),
    value: import_zod11.default.string({
...
var AudioConfigurationSchema = import_zod13.default.object({
  channels: import_zod13.default.nativeEnum(Channels, {
    description: "Number of channels in the input audio."
  }),
  encoding: import_zod13.default.nativeEnum(AudioEncoding, {
    description: "Encoding of the input audio."
  }),
  sampleRate: import_zod13.default.number({
    description: "Sample rate of the input audio."
  })
});
var ContextConfigurationSchema = import_zod13.default.object({
  text: import_zod13.default.string(),
  type: import_zod13.default.enum(["editable", "persistent", "temporary"]).optional()
});
var SessionSettingsSchema = import_zod13.default.object({
  audio: AudioConfigurationSchema.optional(),
  context: ContextConfigurationSchema.optional(),
  languageModelApiKey: import_zod13.default.string().optional(),
  customSessionId: import_zod13.default.string().optional(),
  systemPrompt: import_zod13.default.string().optional()
});

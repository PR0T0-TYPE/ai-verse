...
var JSONErrorMessageSchema = z6.object({
...
var TimeSliceSchema = z7.object({
  begin: z7.number(),
  end: z7.number()
});

// src/models/user-interruption-message.ts
var UserInterruptionMessageSchema = z8.object({
  type: z8.literal("user_interruption"),
  time: z8.union([TimeSliceSchema, z8.number(), z8.null()]).catch(null)
}).transform((obj) => {
  return Object.assign(obj, {
    receivedAt: /* @__PURE__ */ new Date()
  });
...
import z9 from "zod";
var UserTranscriptMessageSchema = z9.object({
  type: z9.literal("user_message"),
  message: z9.object({
...
// src/models/json-message.ts
var JSONMessageSchema = z10.union([
...
// src/models/auth.ts
import z11 from "zod";
var AuthStrategySchema = z11.union([
  z11.object({
    type: z11.literal("apiKey"),
    value: z11.string({
      description: "API key for the Hume API is required"
    })
  }),
  z11.object({
    type: z11.literal("accessToken"),
    value: z11.string({
...
var AudioConfigurationSchema = z13.object({
  channels: z13.nativeEnum(Channels, {
    description: "Number of channels in the input audio."
  }),
  encoding: z13.nativeEnum(AudioEncoding, {
    description: "Encoding of the input audio."
  }),
  sampleRate: z13.number({
    description: "Sample rate of the input audio."
  })
});
var ContextConfigurationSchema = z13.object({
  text: z13.string(),
  type: z13.enum(["editable", "persistent", "temporary"]).optional()
});
var SessionSettingsSchema = z13.object({
  audio: AudioConfigurationSchema.optional(),
  context: ContextConfigurationSchema.optional(),
  languageModelApiKey: z13.string().optional(),
  customSessionId: z13.string().optional(),
